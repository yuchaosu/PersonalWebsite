...
![NVIDIA Streaming Multiprocessors](sm.jpeg "NVIDIA GPU Architecture")
...
![NVIDIA CUDA Cores](cudacore.jpg "NVIDIA CUDA Cores")
...
![NVIDIA Tensor Cores](tensorcore.jpg "NVIDIA Tensor Cores")
...
![NVIDIA GPU Memory Hierarchy](memhier.jpg "NVIDIA GPU Memory Hierarchy")
...
![CUDA Program Model](programmodel.png "CUDA Program Model")
...
![Ampere SM Architecture](amperesm.png "Ampere SM Architecture")
...
![CUDA Thread Indexing](threadidx.png "CUDA Thread Indexing")
